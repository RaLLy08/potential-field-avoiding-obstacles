...
import { initCheckbox, onCheckboxChange, onSelectChange, withLsSubscribe } from "./helpers.js";
...
class VehicleDisplay {
    ...
    #yInput;
    constructor() {
        this.#totalForceInput = document.getElementById(
            VehicleDisplay.TOTAL_FORCE_ID
        );
        this.#attractiveForceInput = document.getElementById(
            VehicleDisplay.ATTRACTIVE_FORCE_ID
        );
        this.#repulsiveForceTotalInput = document.getElementById(
            VehicleDisplay.REPULSIVE_FORCE_TOTAL_ID
        );
        this.#repulsiveForceNewTotalInput = document.getElementById(
            VehicleDisplay.REPULSIVE_FORCE_NEW_TOTAL_ID
        );
...
export const vehicleDisplay = new VehicleDisplay();
...
class CanvasDisplay {
    ...
    static REPULSIVE_FORCE_TOTAL_CHECKBOX_ID =
        "repulsive-force-total-field-checkbox";
    static REPULSIVE_FORCE_NEW_TOTAL_CHECKBOX_ID =
        "repulsive-force-new-total-field-checkbox";
    static REPULSIVE_FORCE_CHECKBOX_ID = "repulsive-force-field-checkbox";
    static REPULSIVE_FORCE_NEW_CHECKBOX_ID =
        "repulsive-force-new-field-checkbox";
    static OBSTACLES_FIELD_RADIUS_CHECKBOX_ID =
        "obstacles-radius-field-checkbox";
    ...
    static REPULSIVE_FORCE_NEW_TOTAL_COLOR_ID =
        "repulsive-force-new-total-color";
    ...
    #setColors() {
        document.getElementById(
            CanvasDisplay.TOTAL_FORCE_COLOR_ID
        ).style.backgroundColor = COLOR.TOTAL_FORCE;
        document.getElementById(
            CanvasDisplay.ATTRACTIVE_FORCE_COLOR_ID
        ).style.backgroundColor = COLOR.ATTRACTIVE_FORCE;
        document.getElementById(
            CanvasDisplay.VECTORS_FLOW_COLOR_ID
        ).style.backgroundColor = COLOR.VECTORS_FLOW;
        document.getElementById(
            CanvasDisplay.OBSTACLES_FIELD_RADIUS_COLOR_ID
        ).style.backgroundColor = COLOR.OBSTACLES_FIELD_RADIUS;
        document.getElementById(
            CanvasDisplay.VEHICLE_COLOR_ID
        ).style.backgroundColor = COLOR.VEHICLE;
        document.getElementById(
            CanvasDisplay.VEHICLE_FIELD_RADIUS_COLOR_ID
        ).style.backgroundColor = COLOR.VEHICLE_FIELD_RADIUS;
        document.getElementById(
            CanvasDisplay.REPULSIVE_FORCE_COLOR_ID
        ).style.backgroundColor = COLOR.REPULSIVE_FORCE;
        document.getElementById(
            CanvasDisplay.REPULSIVE_FORCE_NEW_COLOR_ID
        ).style.backgroundColor = COLOR.REPULSIVE_FORCE_NEW;
        document.getElementById(
            CanvasDisplay.REPULSIVE_FORCE_TOTAL_COLOR_ID
        ).style.backgroundColor = COLOR.REPULSIVE_FORCE;
        document.getElementById(
            CanvasDisplay.REPULSIVE_FORCE_NEW_TOTAL_COLOR_ID
        ).style.backgroundColor = COLOR.REPULSIVE_FORCE_NEW;
        document.getElementById(
            CanvasDisplay.OBSTACLES_COLOR_ID
        ).style.backgroundColor = COLOR.OBSTACLE;
    }
}
...
const valueToElementCheckbox = {
    ...
    vectorsFlow: document.getElementById(
        CanvasDisplay.VECTORS_FLOW_CHECKBOX_ID
    ),
    attractiveForce: document.getElementById(
        CanvasDisplay.ATTRACTIVE_FORCE_CHECKBOX_ID
    ),
    repulsiveForceTotal: document.getElementById(
        CanvasDisplay.REPULSIVE_FORCE_TOTAL_CHECKBOX_ID
    ),
    repulsiveForceNewTotal: document.getElementById(
        CanvasDisplay.REPULSIVE_FORCE_NEW_TOTAL_CHECKBOX_ID
    ),
    obstaclesFieldRadius: document.getElementById(
        CanvasDisplay.OBSTACLES_FIELD_RADIUS_CHECKBOX_ID
    ),
    vehicle: document.getElementById(CanvasDisplay.VEHICLE_CHECKBOX_ID),
    vehicleFieldRadius: document.getElementById(
        CanvasDisplay.VEHICLE_FIELD_RADIUS_CHECKBOX_ID
    ),
    repulsiveForce: document.getElementById(
        CanvasDisplay.REPULSIVE_FORCE_CHECKBOX_ID
    ),
    repulsiveForceNew: document.getElementById(
        CanvasDisplay.REPULSIVE_FORCE_NEW_CHECKBOX_ID
    ),
    obstacles: document.getElementById(CanvasDisplay.OBSTACLES_CHECKBOX_ID),
};

const valueToElementSelect = {
    obstaclesMap: document.getElementById(
        CanvasDisplay.OBSTACLES_MAP_SELECT_ID
    ),
};
...
for (const value of Object.keys(valueToElementCheckbox)) {
    ...
    onCheckboxChange(
        valueToElementCheckbox[value],
        (state) => (withLs[value] = state)
    );
}
...
for (const value of Object.keys(valueToElementSelect)) {
    onSelectChange(valueToElementSelect[value], (state) => {
        ...
        withLs.onSelectChange(
            index,
            CanvasDisplay.OBSTACLES_MAP_SELECT_OPTIONS
        );
    });
}

export const canvasDisplay = withLs;
...
class CanvasActions {
    ...
    constructor() {
        this.#onButtonClick(
            document.getElementById(CanvasActions.RESET_VEHICLE_BUTTON_ID),
            () => this.onResetVehicle()
        );
        this.#onButtonClick(
            document.getElementById(CanvasActions.PAUSE_RESUME_BUTTON_ID),
            (target) => {
...
export const canvasActions = new CanvasActions();
